...
var _dictionaryAPPViewJs = require("./views/dictionaryAPPView.js");
var _dictionaryAPPViewJsDefault = parcelHelpers.interopDefault(_dictionaryAPPViewJs);
const controlDictionaryAPP = async function() {
    try {
        const givenWord = (0, _dictionaryAPPViewJsDefault.default).getWordQuery();
        if (!givenWord) return;
    ...
    */ setTimeout(function() {
            ...
            (0, _dictionaryAPPViewJsDefault.default).render(data);
...
const palyAudio = function() {
    if (!_modelJs.state.audioSource) return;
    const audio = new Audio(_modelJs.state.audioSource);
    audio.play();
};
const init = function() {
    (0, _dictionaryAPPViewJsDefault.default).addLoadHandler(controlDictionaryAPP);
    (0, _dictionaryAPPViewJsDefault.default).addClickHandlerToPlayButton(palyAudio);
    (0, _dictionaryAPPViewJsDefault.default).addClickHandlerToModeSwitcher();
    (0, _dictionaryAPPViewJsDefault.default).addHandlerFontChange();
    (0, _dictionaryAPPViewJsDefault.default).addHandlerInputSearch(controlDictionaryAPP);
};
init();

},{"./model.js":"Y4A21","./config.js":"k5Hzs","./views/dictionaryAPPView.js":"jvnsz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "getDictionaryWordInformation", ()=>getDictionaryWordInformation);
var _configJs = require("./config.js");
...
const getDictionaryWordInformation = async function(searchWord) {
    try {
        ...
        if (wordInformation[0].phonetics.length > 0) state.phoneticsName = wordInformation[0].phonetics[1].text;
        else // If the word has no phonetic transcription, add a default value
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_URL_FOR_DICTIONARY", ()=>API_URL_FOR_DICTIONARY);
parcelHelpers.export(exports, "TIMEOUT_SEC", ()=>TIMEOUT_SEC);
parcelHelpers.export(exports, "SHOW_COUNTRIES_SEC", ()=>SHOW_COUNTRIES_SEC);
const API_URL_FOR_DICTIONARY = "https://api.dictionaryapi.dev/api/v2/entries/en/";
...
},{"./config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jvnsz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DictionaryAPPView", ()=>DictionaryAPPView);
var _iconArrowDownSvg = require("../../assets/images/icon-arrow-down.svg");
var _iconArrowDownSvgDefault = parcelHelpers.interopDefault(_iconArrowDownSvg);
var _iconPlaySvg = require("../../assets/images/icon-play.svg");
var _iconPlaySvgDefault = parcelHelpers.interopDefault(_iconPlaySvg);
var _iconNewWindowSvg = require("../../assets/images/icon-new-window.svg");
var _iconNewWindowSvgDefault = parcelHelpers.interopDefault(_iconNewWindowSvg);
class DictionaryAPPView {
    _parentElement = document.querySelector(".dictionary-app");
    _data;
    _errorMessage = "Sorry pal, we couldn't find definitions for the word you were looking for. You can try the search again at later time or head to the web instead.";
    _audioSource;
    ...
    addClickHandlerToModeSwitcher() {
        ...
        label.addEventListener("click", (e)=>{
            ...
            if (modeSwitcher.checked === true) {
                ...
                document.querySelector(".cta__word-form .input__word-name").style.backgroundColor = "#1f1f1f";
            } else {
                ...
                document.querySelector(".cta__word-form .input__word-name").style.backgroundColor = "#f4f4f4";
            }
        });
    }
          ...
          <div class="dictionary dictionary-app__active">
            <div class="dictionary__header-word--info">
             <div class="dictionary__header-word">
              <h1 class="dictionary__word-name heading-One">${this._data.resultWord}
              </h1>
               <span>${this._data.phoneticsName}</span>
              </div>
              <img class="dictionary__play" src="${(0, _iconPlaySvgDefault.default)}" alt="play-icon" />
            </div>
            
            <div class="dictionary__definition">

             ${this._data.meanings.map((el)=>`
                 <div class="dictionary__definition-header">
               <h2 class="dictionary__definition-heading-text heading-two">${el.partOfSpeech}</h2>
               <hr>
              </div>
                ...
                <div class="dictionary__definition-list">
                 ${el.definitions.map((el)=>`
                   ...
                   <li>${el.definition}</li>
                     ...
                     <spn class="dictionary__definition-example">${el.example === undefined ? "" : el.example}</spn>
                   `).join("")}
                </div>
            ...
            <div class="dictionary__source">
              ...
              <div class="dictionary__source-link">
                <a class="dictionary__source-url" href="${this._data.sourceUrls}" target="_blank" rel="noopener noreferrer">${this._data.sourceUrls}
     <img class="dictionary__new-window" src="${(0, _iconNewWindowSvgDefault.default)}" alt="New Window" />  
    </a>
...
},{}],"19bci":[function(require,module,exports,__globalThis) {
module.exports = require("fe52283b4a4e8869").getBundleURL('hWUTQ') + "icon-play.68768292.svg" + "?" + Date.now();

},{"fe52283b4a4e8869":"lgJ39"}],"emblb":[function(require,module,exports,__globalThis) {
module.exports = require("494ae7e1fc14a12c").getBundleURL('hWUTQ') + "icon-new-window.50608efb.svg" + "?" + Date.now();

},{"494ae7e1fc14a12c":"lgJ39"}]},["ik2hV","aenu9"], "aenu9", "parcelRequire94c2")
